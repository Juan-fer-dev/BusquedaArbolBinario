...
public class FrmOrdenamiento extends JFrame {
    ...
    private void btnBuscar(ActionEvent evt) {
        if (cmbCriterio.getSelectedIndex() >= 0) {
            ...
            ArbolBinario arbol = Documento.getArbolBinario(cmbCriterio.getSelectedIndex());
            BusquedaArbolBinario busqueda = new BusquedaArbolBinario(arbol);
            busqueda.buscar(tblDocumentos, terminoBusqueda);
        }
    }
